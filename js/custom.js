...
jQuery(function ($) {
    ...
    $(document).ready(function () {
        $('.navbar-mobile-menu').click(function () {
            $(this).find('.button-menu').toggleClass('active');
            $(this).parent().toggleClass('active');
            $('.navBlock').toggleClass('active');
            $('body').toggleClass('activeMenuBox')
        });
        $(function () {
            ...
            if (width > 991) {
                ...
                $('.error404 .pageTemplate').css({
                    height: height - 73
                });
            }
            if (height < 640) {
                $('.banner').css('align-items', 'flex-start');
            }
        });
        $(function () {
            $('.whatWeDo__children').hide();
            $('.whatWeDo__parent .btn-more').click(function () {
                $(this).parent().parent().hide();
                $(this).parent().parent().next('.whatWeDo__children').show();
                $(this).parent().parent().parent().parent().prev().children().append('<div class="append-back themeAnimated fadeInUp"><i class="theme-icon-banner"></i><button type="button" class="btn btn-back">Back</button></div>')
                $('.page-template-whatwedo-page').css('overflow', 'scroll');
                $('.whatWeDo').removeAttr('style');
                $('.append-back .btn-back').click(function () {
                    var width = $(window).width();
                    var height = $(window).height();
                    $(this).parent().parent().parent().next().children().children('.whatWeDo__parent').show();
                    $(this).parent().parent().parent().next().children().children('.whatWeDo__children').hide();
                    $(this).parent().remove();
                    $('body').removeClass('singleacitve');
                    $('.page-template-whatwedo-page').css('overflow', 'hidden');
                    if (width > 991) {
                        $('.whatWeDo').css({
                            height: height - 56
                        });
        ...
        $(function () {
            $('.whatWeDo').on('click', 'a[href^="#"]', function (e) {
                var id = $(this).attr('href');
                var removeH = $('.header').height();
                var $id = $(id);
                if ($id.length === 0) {
                    return;
                }
            ...
            $(window).scroll(function () {
                if ($('.whatWeDo').length != 0) {
                    var step1 = $('#whatWeDoStep1').offset().top;
                    var step2 = $('#whatWeDoStep2').offset().top;
                    var step3 = $('#whatWeDoStep3').offset().top;
                    var step4 = $('#whatWeDoStep4').offset().top;
                    if ($(window).scrollTop() >= step1 - 10) {
                        $('.whatWeDo__leftBox #step1').addClass('active');
                    } else {
                        $('.whatWeDo__leftBox #step1').removeClass('active');
                    }
                    if ($(window).scrollTop() >= step2 - 10) {
                        $('.whatWeDo__leftBox #step2').addClass('active');
                        $('.whatWeDo__leftBox #step1').removeClass('active');
                    } else {
                        $('.whatWeDo__leftBox #step2').removeClass('active');
                    }
                    if ($(window).scrollTop() >= step3 - 10) {
                        $('.whatWeDo__leftBox #step3').addClass('active');
                        $('.whatWeDo__leftBox #step2').removeClass('active');
                    } else {
                        $('.whatWeDo__leftBox #step3').removeClass('active');
                    }
                    if ($(window).scrollTop() >= step4 - 10) {
                        $('.whatWeDo__leftBox #step4').addClass('active');
                        $('.whatWeDo__leftBox #step3').removeClass('active');
                    } else {
                        $('.whatWeDo__leftBox #step4').removeClass('active');
                    }
                };
            });
        });
        $(function () {
            $('.banner').on('click', 'a[href^="#"]', function (e) {
                var id = $(this).attr('href');
                var removeH = $('.header').height();
                var $id = $(id);
                if ($id.length === 0) {
        ...
        $(function () {
            $('.navBlock').on('click', 'a[href^="#"]', function (e) {
                var id = $(this).attr('href');
                var removeH = $('.header').height();
                var $id = $(id);
                if ($id.length === 0) {
        ...
        $(function () {
            $('.navigation').on('click', '.mainBoxnavigation > a', function (e) {
                e.preventDefault();
                var link = jQuery(this).attr('href');
                var data2 = $(this).parent().parent().parent().attr('id');
                var data3 = " .main-tabs #" + data2 + " .listItems";
                var data4 = " .main-tabs #" + data2 + " .navigation .mainBoxnavigation";
                $(this).parent().parent().prev().html("<div class='loading'>Loading...</div>");
                $(this).parent().parent().prev().load(link + data3);
                $(this).parent().parent().load(link + data4);
            });
        });
        $(function () {
            $('#menu-main-menu li').append('<span></span>')
        });
        $(function () {
            $('body .btn-more').click(function () {
                $('body').addClass('singleacitve');
            });
        });
    });
});
